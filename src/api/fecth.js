// api/fetchData.js
export const fetchTotalFarmers = async () => {
  const response = await fetch('/api/totalFarmers');
  const data = await response.json();
  return data.totalFarmers;
};

export const fetchTotalFarmlands = async () => {
  const response = await fetch('/api/totalFarmlands');
  const data = await response.json();
  return data.totalFarmlands;
};

export const fetchTotalActiveCropCycle = async () => {
  const response = await fetch('/api/totalActiveCropCycle');
  const data = await response.json();
  return data.totalActiveCropCycle;
};

export const fetchTotalFarmlandSize = async () => {
